...
jQuery.getJSON(GetQueryStringParams("config","https://liofpi.github.io/twitter-network/config/config.json"), function(data, textStatus, jqXHR) {
	config=data;
...
function configSigmaElements(config) {
	...
	//	for (b in sigInst.clusters) a.push('<div style="line-height:12px"><a href="#' + b + '"><div style="width:40px;height:12px;border:1px solid #fff;background:' + b + ';display:inline-block"></div> Group ' + (x++) + ' (' + sigInst.clusters[b].length + ' members)</a></div>');
        a.push('<div style="line-height:12px"><a href="indexMarch.html">March(16 members)</a></div>');
        a.push('<div style="line-height:12px"><a href="indexApril.html">April(55 members)</a></div>');
        a.push('<div style="line-height:12px"><a href="indexMay.html">May(91 members)</a></div>');
        a.push('<div style="line-height:12px"><a href="indexJune.html">June(115 members)</a></div>');
        a.push('<div style="line-height:12px"><a href="indexJuly.html">July(987 members)</a></div>');
        a.push('<div style="line-height:12px"><a href="index.html">August(1401 members)</a></div>');
    //a.sort();
